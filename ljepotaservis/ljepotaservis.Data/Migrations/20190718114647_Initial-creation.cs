        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreId = table.Column<int>(nullable: false),
                    StartOfShift = table.Column<DateTime>(nullable: true),
                    EndOfShift = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_UserStores_UserStoreEmployeeId",
                        column: x => x.UserStoreEmployeeId,
                        principalTable: "UserStores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_UserStores_UserStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_UserStoreEmployeeId",
                table: "Reservations",
                column: "UserStoreEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_UserStoreId",
                table: "Reservations",
                column: "UserStoreId");
